namespace Runtime.Extensions.AvaTripInitialization
{
    using System;
    ...
    public class DefinePosExtensionPackageTrigger : IRequestTriggerAsync
    {
        ...
        public Task OnExecuted(Request request, Response response)
        {
            ...
            extensionPackageDefinition.Name = "Rajendra.Commerce";
            extensionPackageDefinition.Publisher = "Rajendra Shivaraya Ltd.";
